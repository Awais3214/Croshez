import 'package:croshez/admin/dashboard/bloc/dashboard_stats_bloc.dart';
...
import '../services/get_dashboard_stats.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    super.initState();
    DashboardStatusEndpoint().getstatus().then((value) {
      lStats = value;
      context.read<DashboardStatsBloc>().add(DashboardLoaded(lStats));
      // context.read<DashboardStatsBloc>().state.
      setState(() {});
    });
  }
        ...
        children: [
          BlocBuilder<DashboardStatsBloc, DashboardStatsState>(
            builder: (context, state) {
                                ...
                                Text(
                                  ...
                                  style: GoogleFonts.inter(
                                    fontSize: HelperMethods()
                                        .getMyDynamicFontSize(29),
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                                SizedBox(
                                  height: HelperMethods().getMyDynamicHeight(4),
                                ),
                                /* Text(
                                  'Lets check your store',
                                  style: GoogleFonts.inter(
                                    fontSize: HelperMethods()
                      ...
                      child: Row(
                        children: List.generate(
                          ...
                          (index) => statusContainer(
                            text: 'Total ${state.stats.keys.toList()[index]}',
                            number: state.stats.values.toList()[index]['total'],
                            icon: (index == 0
                                ? Icons.store
                                : index == 1
                                    ? Icons.people_alt
              ...
              } else if (state is DashboardStatsEmpty) {
                return Column(
  ...
  Widget statusContainer({
    ...
    return Container(
      ...
      // height: HelperMethods().getMyDynamicHeight(182),
      width: HelperMethods().getMyDynamicWidth(254),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            width: HelperMethods().getMyDynamicHeight(48),
            decoration: BoxDecoration(
          ...
          SizedBox(
            height: HelperMethods().getMyDynamicHeight(8),
          ),
          Text(
            number.toString(),
            // '345',
  ...
  /* Widget _searchBarWidget() {
    return Container(
      ...
      height: HelperMethods().getMyDynamicHeight(48),
      width: HelperMethods().getMyDynamicWidth(282),
      // child: ,
    );
  } */
  ...
  Widget _profileIconWidget() {
    return Row(
      children: [
        Container(
          height: HelperMethods().getMyDynamicHeight(58),
          width: HelperMethods().getMyDynamicHeight(58),
